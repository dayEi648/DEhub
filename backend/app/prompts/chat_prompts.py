...
CHAT_DEFAULT_SYSTEM_PROMPT = (
    ...
    "1. search_blog：检索 DE Hub 博客文章。当用户与你的交流提及 DE Hub 的博客文章，或者用户表达出了对博客文章的兴趣时，请使用该工具，需要时可以提供跳转链接。\n"
    "2. search_web：联网搜索获取实时信息。当用户询问时事新闻、最新技术动态、股价天气等时效性内容，或明确要求'搜索一下''联网查询'时，请使用该工具。"
)
