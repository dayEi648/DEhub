...
- **User-requested review**: Only when the developer explicitly asks for a system-level comprehensive review, expand the review scope to cover the entire system using the guidelines below. There is no separate `requesting-code-review` skill available.
