  ...
  return (
    ...
    >
      <div style={{ display: 'flex', alignItems: 'flex-start', gap: 'var(--spacing-md)' }}>
        <UserAvatar url={comment.user.avatar_url} name={comment.user.username} size={40} iconSize={18} />
        ...
        <div style={{ maxWidth: 800, margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 'var(--spacing-lg)', fontSize: 14, color: 'var(--color-muted-soft)', flexWrap: 'wrap' }}>
            <span style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
              <UserAvatar url={post.author.avatar_url} name={post.author.username} size={24} iconSize={12} />
